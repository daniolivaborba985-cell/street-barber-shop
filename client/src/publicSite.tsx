...
function ClubHeader() {
  return <header className="site-header club-site-header"><InternalLink className="brand" href="/#inicio"><img src="/manus-storage/logo_41568a93.jpeg" alt="Street Barber Shop" /><span>STREET<small>BARBER SHOP</small></span></InternalLink><nav aria-label="Navegação do Street Barber Clube"><InternalLink href="/clube">O Clube</InternalLink><InternalLink href="/planos">Planos</InternalLink><a href="#beneficios">Benefícios</a><a href="#vip">Área VIP</a><InternalLink href="/#inicio" className="nav-cta">Voltar ao site <ArrowRight size={15} /></InternalLink></nav></header>
}
...
function ClubPage() {
  ...
  return <div className="app inner-page club-app"><ClubHeader /><main className="club-page club-page-live"><div className="club-live-hero"><div><p className="eyebrow">STREET CLUB · CLIENTE VIP</p><h1>O próximo nível<br /><em>da sua presença.</em></h1><p className="page-lead">Uma comunidade de benefícios para manter seu visual em dia, aproveitar vantagens e fazer parte da Street Barber Shop além da cadeira.</p><div className="club-actions"><button type="button" className="primary" onClick={() => setMode('contract')}>Escolher meu plano <ArrowRight size={17} /></button><button type="button" className="secondary" onClick={() => { setFeedback(''); setMode('login') }}><Crown size={16} /> Acessar área VIP</button></div></div><div className="club-live-mark"><Crown size={30} /><span>STREET</span><small>VIP COMMUNITY</small></div></div>

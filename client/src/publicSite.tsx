...
function ClubPage() {
  ...
  const submitRequest = (event) => {
    ...
    request.mutate({ ...form, planSlug: selectedPlan.slug }, {
      onSuccess: (result) => { setFeedback(`Solicitação registrada para o plano ${selectedPlan.name}. O status está pendente até a confirmação do pagamento; nenhum benefício é ativado antes da aprovação.`); setLoginForm({ email: form.email, phone: form.phone }); setMode('login'); return result },
